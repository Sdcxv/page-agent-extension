		...
		if (node.tagName) {
			...
			if (tagName === 'iframe') {
				try {
					...
					// Cross-origin iframe access is blocked by browser security policy.
					// This is expected behavior and not an error - silently skip these iframes.
					// The agent cannot interact with cross-origin iframes anyway.
				}
			}
